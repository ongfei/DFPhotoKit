...
- (void)viewDidLoad {
    ...
    [self.collectionView registerClass:[DFPhotoKitCollectionCell class] forCellWithReuseIdentifier:@"PhotoKitCollectionCell"];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    DFPhotoKitCollectionCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"PhotoKitCollectionCell" forIndexPath:indexPath];
...
@interface DFPhotoKitCollectionCell ()
...
@implementation DFPhotoKitCollectionCell
